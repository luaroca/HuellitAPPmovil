            ...
            child: Column(
              ...
              children: [
                const Text(
                  ...
                  style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF476AE8)),
                ),
                ...
                Wrap(
                  ...
                  children: diasSemana.map((dia) {
                    ...
                    return FilterChip(
                      ...
                      selectedColor: const Color(0xFF476AE8),
                ...
                Column(
                  children: interesesList.map((interes) {
                    final seleccionado = interesesSeleccionados.contains(interes);
                    return CheckboxListTile(
                      value: seleccionado,
                      onChanged: (v) {
                        final nuevos = List<String>.from(interesesSeleccionados);
                        v! ? nuevos.add(interes) : nuevos.remove(interes);
                        onActualizarIntereses(nuevos);
                      },
                      title: Text(interes, style: const TextStyle(fontSize: 17)),
                      controlAffinity: ListTileControlAffinity.leading,
                      activeColor: const Color(0xFF476AE8),
                      dense: false,
