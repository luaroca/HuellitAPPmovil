    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _rowIconInfo(
              Icons.star, 'Experiencia', casa.experiencia ? 'Sí' : 'No'),
                  ...
                  ...mascotasDocs.map((doc) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: const Color(0xFFBDEEE1)),
                      ),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
